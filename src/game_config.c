...
#else
#define CFG_EXPL_IMPACT_RADIUS 28
#endif
#endif
...
#else
#define CFG_ENEMY_RENDER_MIN_Y 24
#endif
#endif
...
#else
#define CFG_AMMO_INDICATOR_SIZE 1
#endif
#endif
...
const GameConfig g_game_cfg = {
    ...
    .theme = {
        .classic = {
            ...
            .crosshair_center_color = COL_YELLOW,
            .star_color = COL_GRAY,
            .ammo_color = RGB565(CFG_AMMO_INDICATOR_R, CFG_AMMO_INDICATOR_G, CFG_AMMO_INDICATOR_B),
            .overlay_bg_color = COL_BLACK,
            .overlay_title_color = COL_CYAN,
            .overlay_label_color = COL_WHITE,
            .overlay_value_color = COL_YELLOW,
            .overlay_next_color = COL_GREEN,
            .game_over_title_color = COL_RED,
            .game_over_subtitle_color = COL_WHITE,
            .enemy_trail_lead_r = CFG_TRAIL_LEAD_R,
            .enemy_trail_lead_g = CFG_TRAIL_LEAD_G,
            .enemy_trail_lead_b = CFG_TRAIL_LEAD_B,
            .enemy_trail_tail_r = CFG_TRAIL_TAIL_R,
            .enemy_trail_tail_g = CFG_TRAIL_TAIL_G,
            .enemy_trail_tail_b = CFG_TRAIL_TAIL_B,
            .enemy_tip_color = RGB565(CFG_TRAIL_TIP_R, CFG_TRAIL_TIP_G, CFG_TRAIL_TIP_B),
            .enemy_tip_radius = 0,
            .player_trail_lead_r = CFG_PLAYER_TRAIL_LEAD_R,
            .player_trail_lead_g = CFG_PLAYER_TRAIL_LEAD_G,
            .player_trail_lead_b = CFG_PLAYER_TRAIL_LEAD_B,
            .player_trail_tail_r = CFG_PLAYER_TRAIL_TAIL_R,
            .player_trail_tail_g = CFG_PLAYER_TRAIL_TAIL_G,
            .player_trail_tail_b = CFG_PLAYER_TRAIL_TAIL_B,
            .player_missile_main_color = COL_WHITE,
            .player_missile_shadow_color = COL_GRAY,
        },
        .alternate = {
            .hud_label_color = COL_CYAN,
            .hud_score_value_color = COL_ORANGE,
            .hud_wave_value_color = COL_YELLOW,
            .crosshair_color = COL_CYAN,
            .crosshair_center_color = COL_ORANGE,
            .star_color = COL_BLUE,
            .ammo_color = COL_ORANGE,
            .overlay_bg_color = COL_DKBLUE,
            .overlay_title_color = COL_ORANGE,
            .overlay_label_color = COL_CYAN,
            .overlay_value_color = COL_YELLOW,
            .overlay_next_color = COL_GREEN,
            .game_over_title_color = COL_ORANGE,
            .game_over_subtitle_color = COL_WHITE,
            .enemy_trail_lead_r = 255u,
            .enemy_trail_lead_g = 255u,
            .enemy_trail_lead_b = 255u,
            .enemy_trail_tail_r = 135u,
            .enemy_trail_tail_g = 206u,
            .enemy_trail_tail_b = 235u,
            .enemy_tip_color = RGB565(255u, 105u, 180u),
            .enemy_tip_radius = 3,
            .player_trail_lead_r = 255u,
            .player_trail_lead_g = 220u,
            .player_trail_lead_b = 120u,
            .player_trail_tail_r = 96u,
            .player_trail_tail_g = 40u,
            .player_trail_tail_b = 8u,
            .player_missile_main_color = COL_ORANGE,
            .player_missile_shadow_color = COL_YELLOW,
        },
    },
    .audio = {
